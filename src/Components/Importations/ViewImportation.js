        ...
        <div>
            ...
            >
                ...
                <DialogContent dividers>
                    ...
                    {params.mail.concerned!==null && <TextField sx={{ width : 1/2 , marginY : 1 , paddingInlineEnd : 1 }} id="outlined-basic" multiline rows={2} label={t("concerned")} variant="filled" value={params.mail.concerned} inputProps={{ readOnly: true }}/>}
                    {params.mail.notes!==null && <TextField sx={{ width : 1/2 , marginY : 1 }} id="outlined-basic" multiline rows={2} label={t("notes")} variant="filled" value={params.mail.notes} inputProps={{ readOnly: true }}/>}
                    {params.mail.references!==null &&<TextField sx={{ marginY : 1 }} id="outlined-basic" fullWidth label={t("references")}variant="filled" rows={4} value={params.mail.references} inputProps={{ readOnly: true }}/>}
