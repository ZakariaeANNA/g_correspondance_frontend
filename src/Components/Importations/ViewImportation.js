        ...
        <div>
            ...
            >
                ...
                <DialogContent dividers>
                    ...
                    <TextField sx={{ marginY : 1 }} id="outlined-basic" fullWidth multiline label={t("sender")} variant="filled" value={params.sender.fullnamela} inputProps={{ readOnly: true }}/>                                      
                    ...
                    <TextField sx={{ marginY : 1 }} id="outlined-basic" fullWidth multiline label={t("subject_message")} variant="filled" value={params.title} inputProps={{ readOnly: true }}/>
